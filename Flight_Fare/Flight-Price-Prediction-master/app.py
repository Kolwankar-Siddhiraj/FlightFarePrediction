...
# My custom logs start here
log = Logs('test_logs.log')

# log.addLog("INFO", "Executioin started successfully !")
...
app.config['MYSQL_DB'] = 'flight_fare'
...
model = pickle.load(open("flight_Fare_Model_2.pkl", "rb"))

log.addLog("INFO", "flight_Fare_Model_2.pkl is loded successfully !")
...
def home():
    ...
    log.addLog("INFO", "Rendering tamplate <home.html> !")
    #return render_template("home.html")
    return render_template('home.html', prediction_text=" Calculate your average flight fare ! ")
...
def predict():
    if request.method == "POST":
        ...
        jrny_day = Journey_day
        jrny_month = Journey_month
        ...
        log.addLog("INFO", "User inputs collected Successfully !")
    ...
    #    'Destination_Kolkata', 'Destination_New Delhi']
        ...
        log.addLog("INFO", "Prediction model Started !")
        ...
        try:
            ...
            crsr.execute(f"INSERT INTO prediction_record(airline, source_place, destination_place, jrny_day, jrny_month, total_stop, predicted_fare) VALUES('{airline}', '{source_place}','{destination_place}','{jrny_day}','{jrny_month}','{Total_stop}', '{predicted_fare}')")
        ...
        log.addLog("INFO", "Rendering tamplate <home.html> with predicted Flight Fare !")
        
        return render_template('home.html', prediction_text="Your average flight fare will be Rs. {} ".format(output))
...
def database():
    ...
    heading = ("Airline", "Source", "Destination", "Day", "Month", "Total Stops", "Predicted Fare")
    all_data = ""
    try:
        log.addLog("INFO", "Creating cursor to access Database MySQL !")
        crsr = mysql.connection.cursor()
...
if __name__ == "__main__":
    ...
    if var:
        log.addLog("INFO", "APP Started Successfully !")
        var = False
